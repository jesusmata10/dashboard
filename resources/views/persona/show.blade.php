...
@section('content')
    <div class="row">
        ...
        @endif--}}
            <form action="{{ route('personas.store') }}" class="form" data-toggle="validator" id="personaForm"
                  method="POST" name="personaForm" role="form">
                {{ csrf_field() }}
                <div class="card">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class=" col-sm-12 col-md-6">
                                <a href="{{ url('/personas') }}" type="button" class="btn btn-sm btn-danger float-right">Agregar</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <table class="table table-sm table-bordered table-hover ">
                                    ...
                                    @foreach($carga_familiar as $items)
                                        <tr class="text-center">
                                            ...
                                            <td class="" >
                                                <a href="{{ url('/personas/'.encrypt($items->id).'/edit') }}" title="Editar" type="button" class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
